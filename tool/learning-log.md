...
### 3/23/26:
* Learned to make an X in Bulma using its website, though not interactive. Use class "delete" add on "is-#size" to change its size
* Still trying to figure out the components to make  a table. Knows it uses `<td>` for small cell.
